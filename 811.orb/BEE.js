...
const crown_unit_1 = require("./01.crown.unit/crown.unit");
...
const ambit_unit_1 = require("./10.ambit.unit/ambit.unit");
const axis_unit_1 = require("./11.axis.unit/axis.unit");
...
const crown_model_1 = require("./01.crown.unit/crown.model");
...
const ambit_model_1 = require("./10.ambit.unit/ambit.model");
const axis_model_1 = require("./11.axis.unit/axis.model");
...
exports.list = [orb_unit_1.default, crown_unit_1.default, fate_unit_1.default, clock_unit_1.default, risk_unit_1.default, weather_unit_1.default, plot_unit_1.default, ambit_unit_1.default, axis_unit_1.default, arena_unit_1.default, delivery_unit_1.default, collect_unit_1.default, menu_unit_1.default, bus_unit_1.default];
const reduceFromOrb = require("./00.orb.unit/orb.reduce");
const reduceFromCrown = require("./01.crown.unit/crown.reduce");
...
const reduceFromAmbit = require("./10.ambit.unit/ambit.reduce");
const reduceFromAxis = require("./11.axis.unit/axis.reduce");
