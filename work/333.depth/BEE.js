...
const reality_unit_1 = require("./01.reality.unit/reality.unit");
...
const reality_model_1 = require("./01.reality.unit/reality.model");
...
exports.list = [depth_unit_1.default, reality_unit_1.default, socket_unit_1.default, collect_unit_1.default, menu_unit_1.default, bus_unit_1.default];
const reduceFromDepth = require("./00.depth.unit/depth.reduce");
const reduceFromReality = require("./01.reality.unit/reality.reduce");
...
class UnitData {
    constructor() {
        ...
        this.reality = new reality_model_1.RealityModel();
