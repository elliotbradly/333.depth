...
exports.OLLAMA_MENU = "[Time action] Ollama Menu";
class OllamaMenu {
    constructor(bale) {
        this.bale = bale;
        this.type = exports.OLLAMA_MENU;
    }
}
exports.OllamaMenu = OllamaMenu;
exports.OPENAI_MENU = "[Time action] OpenAi Menu";
class OpenAIMenu {
    constructor(bale) {
        this.bale = bale;
        this.type = exports.OPENAI_MENU;
    }
}
