...
const rpgmap_unit_1 = require("./04.rpgmap.unit/rpgmap.unit");
...
const rpgmap_model_1 = require("./04.rpgmap.unit/rpgmap.model");
...
exports.list = [space_unit_1.default, focus_unit_1.default, geojson_unit_1.default, hexmap_unit_1.default, rpgmap_unit_1.default, pivot_unit_1.default, collect_unit_1.default, menu_unit_1.default, bus_unit_1.default];
...
const reduceFromRpgmap = require("./04.rpgmap.unit/rpgmap.reduce");
...
class UnitData {
    constructor() {
        ...
        this.rpgmap = new rpgmap_model_1.RpgmapModel();
